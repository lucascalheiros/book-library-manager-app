...
import com.github.lucascalheiros.booklibrarymanager.data.MockBookLibFilesData
...
class HomeFragmentTest {
    ...
    private val fetchFilesUseCase: FetchFilesUseCase = Mockito.mock(FetchFilesUseCase::class.java)

    private val mockModule = module {
        single { fetchFilesUseCase }
    }
    ...
    fun whenOpenHomeAllItemsShouldBeDisplayed() {
        runBlocking {
            Mockito.`when`(fetchFilesUseCase.listFiles()).thenReturn(MockBookLibFilesData.all)
        }
